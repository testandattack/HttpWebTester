...
namespace WebTestItemManager
{
    ...
    {
        private const string ItemManagerRequestCreationComment = "This request generated by the WebTestItemManager code on ";
        ...
        public static WTI_Request CreateNewRequest(string requestUri, HttpMethod method, Dictionary<string, IEnumerable<string>> Headers)
        {
        ...
        public static WTI_Request CreateNewRequest(string requestUri, HttpMethod method, Version version)
        {
            ...
            request.itemComment = $"{ItemManagerRequestCreationComment}{DateTime.Now.ToString("yyyy-MM-dd")}";
            return request;
        }

        public static WTI_Request CreateNewRequest(string requestUri, HttpMethod method, Dictionary<string, IEnumerable<string>> Headers, Version version)
        {
            WTI_Request request = new WTI_Request(requestUri, method);
        ...
        public static Dictionary<string, IEnumerable<string>> CreateApiHeaders()
        {
            return CreateApiHeaders("Bearer {{access_token}}", "{{WebServer1}}", "{{WebServer1}}");
        }

        public static Dictionary<string, IEnumerable<string>> CreateApiHeaders(string tokenName, string refererName, string originName)
        {
            Dictionary<string, IEnumerable<string>> headers = new Dictionary<string, IEnumerable<string>>();
            headers.Add("Accept", new string[] { "application/json, text/plain, */*" });
            headers.Add("Referer", new string[] { refererName });
            headers.Add("Authorization", new string[] { tokenName });
            headers.Add("Origin", new string[] { originName });
            return headers;
        }
        #endregion
