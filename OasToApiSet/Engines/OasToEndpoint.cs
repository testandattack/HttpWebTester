...
{
    public class OasToEndpoint : IEndpoint
    {
        #region -- Properties -----
        private readonly ISettings _settings;
        private readonly ILogger _logger;
        private readonly IParameter _parameterEngine;
        ...
        #region -- Constructors -----
        public OasToEndpoint(ILogger logger, IParameter parameterEngine, ISettings settings, KeyValuePair<OperationType, OpenApiOperation> apiOperation)
        {
        ...
        {
            _logger.ForContext<OasToEndpoint>().Debug("[{method}]: Adding {@OpenApiPathItem} {OpenApiMethod}", "AddEndPoint", pathUri, operation.Key);
